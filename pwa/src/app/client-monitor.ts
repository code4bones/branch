...
function clientMonitorEventName(detail: string): ClientMonitorEventName | null {
  const exact: Record<string, ClientMonitorEventName> = {
    ...
    "delivery receipt: read_accepted_sent": "receipt.read_accepted",
    "delivery receipt: read_accepted_skipped": "receipt.read_accepted",
    "delivery receipt: read_accepted_failed": "receipt.read_accepted",
    "delivery receipt: read_accepted_unmatched": "receipt.read_accepted",
    "delivery receipt: read_accepted_replay": "receipt.read_accepted",
