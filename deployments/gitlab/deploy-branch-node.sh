...
BRANCH_CLIENT_MONITOR_INGEST_TOKEN="$(relay_var CLIENT_MONITOR_INGEST_TOKEN)"
...
BRANCH_OBSERVABILITY_MODE="$(relay_var OBSERVABILITY_MODE)"
...
BRANCH_OBSERVABILITY_MODE="${BRANCH_OBSERVABILITY_MODE:-operator}"
...
chmod 0600 "$compose_env_file"
{
  ...
  printf 'BRANCH_CLIENT_MONITOR_INGEST_TOKEN=%s\n' "$BRANCH_CLIENT_MONITOR_INGEST_TOKEN"
  ...
  printf 'BRANCH_OBSERVABILITY_MODE=%s\n' "$BRANCH_OBSERVABILITY_MODE"
